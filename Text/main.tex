...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.7\textwidth}
        \centering
        \input{tikz/syndromextraction.tex}
        \caption{A distance 5 planar surface code. Black dots represent data qubits, and white dots represent ancillary qubits. Green squares are X-type plaquettes stabilizers and orange squares are Z-type star stabilizers.}
